        ...
        <div className="container">
            ...
            <div className="boxBtn-container">
                <button className="boxBtn1">
                    ...
                    <p1> Claiming Your Strengths starts with the identification of your key
                ...
                <button className="boxBtn2">
                    ...
                    <p1> Tough talks can be awkward and unpleasant, but they are
            ...
            <div className="boxBtn-container">
                ...
                <button className="boxBtn2">
                    ...
                    <p1> Whether we're talking in a team meeting or presenting to an
            ...
            <div className="boxBtn-container">
                <button className="boxBtn1">
                    ...
                    <p1> Almost everyone agrees that networking is important, but we
                ...
                <button className="boxBtn2">
                    ...
                    <p1> This topic is designed to build resilience, well-being, and
            ...
            <div className="boxBtn-container">
                <button className="boxBtn1">
                    ...
                    <p1> Many people think of confidence as a feeling. But in reality, it’s
                ...
                <button className="boxBtn2">
                    ...
                    <p1> Few skills are more valuable and practiced more poorly than
            ...
            <div className="boxBtn-container">
                <button className="boxBtn1">
                    ...
                    <p1> Learn innovative ways to improve your team’s performance and
                ...
                <button className="boxBtn2">
                    ...
                    <p1> Improve your time management skills by sharpening your critical
